<%@ Page Title="" Language="C#" MasterPageFile="~/Master/PDF.Master" AutoEventWireup="true" CodeBehind="ConstanciaAprobacion.aspx.cs" Inherits="WorkFlow.Reportes.PDF.ConstanciaAprobacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="ContenedorPDF">
        ...
        <div class="ContenedorPDFDatos" style="text-align: justify;">
            ...
            &nbsp;se le ha aprobado un Mutuo Hipotecario Endosable por
        ...
        <div class="ContenedorPDFDatos">
            Esta aprobación se encuentra sujeta a las siguientes condiciones suspensivas:
        </div>
        <div class="ContenedorPDFDatos">
            <br />
        ...
        <div class="ContenedorPDFDatos">
            ...
            La tasa de emisión del crédito será fijada por NCH y aceptada por el cliente al momento de suscribirse la escritura pública que da cuenta del mutuo hipotecario, quedando en consecuencia condicionada la oferta a la aceptación de la señalada tasa.
             <br />
            <br />
            La aprobación que da cuenta el presente instrumento tiene una vigencia de
