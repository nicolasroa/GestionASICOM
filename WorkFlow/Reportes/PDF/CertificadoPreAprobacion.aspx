<%@ Page Title="" Language="C#" MasterPageFile="~/Master/PDF.Master" AutoEventWireup="true" CodeBehind="CertificadoPreAprobacion.aspx.cs" Inherits="WorkFlow.Reportes.PDF.CertificadoPreAprobacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="position: relative; width: 100%; height: 100%; margin: 0 auto;" >
        <div class="ParrafoLegal" style="width: 80%; margin-right: auto; margin-left: auto; margin-top:100px;">
            ...
            <br />
            <p style="text-align: center;"><strong>CERTIFICADO DE PREAPROBACIÓN DE CRÉDITO HIPOTECARIO</strong></p>
            ...
            <anthem:Label ID=lblDireccionPropiedad runat="server" AutoUpdateAfterCallBack="True"></anthem:Label>, 
            comuna de
            <anthem:Label ID=lblComunaPropiedad runat="server" AutoUpdateAfterCallBack="True"></anthem:Label>,  ha sido PreAprobada por U.F.
