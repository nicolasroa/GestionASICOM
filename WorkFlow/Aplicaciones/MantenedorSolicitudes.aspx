<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="MantenedorSolicitudes.aspx.cs" Inherits="WorkFlow.Aplicaciones.MantenedorSolicitudes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row spacenavmax">
        <div class="col-md-12">
            <h4>
                <span class="titulo">
                    <%--<img src="../Img/icons/favicon_xsmall.png" />--%>Mantenedor de Solicitudes
                </span>
                <br>
            </h4>
           <%-- <div style="width: 100%;">
            ...
            <anthem:GridView runat="server" ID="gvBusqueda" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Abrir Solicitud" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <anthem:ImageButton ID="btnAbrirAvento" runat="server" ImageUrl="~/Img/Grid/Editar_grid.png"
                    ...
                    <asp:BoundField DataField="RutCliente" HeaderText="Rut" />
