<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="NuevaTasacionIndividual.aspx.cs" Inherits="WorkFlow.Aplicaciones.FlujosParalelos.NuevaTasacionIndividual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row spacenavmax">
        <div class="col-md-12">
            <h4>
                <span class="titulo">
                   <%-- <img src="../../Img/icons/favicon_xsmall.png" />--%>Nueva Tasación Individual/Previa
                </span>
                <br>
            </h4>
            <%--<div style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Buscar Solicitud para Inciar Flujo de Tasación
                </h3>
            </div>
                    ...
                    <anthem:GridView runat="server" ID="gvBusqueda" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Tipo" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <anthem:RadioButtonList ID="rblTipoTasacion" runat="server" AutoUpdateAfterCallBack="true" RepeatDirection="Horizontal">
                                        <Items>
                                            <asp:ListItem Value="1">Individual</asp:ListItem>
                                            <asp:ListItem Value="2">Previa</asp:ListItem>
                                        </Items>
        ...
        <div class="col-md-5 small">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <anthem:HiddenField ID="hdfTipoTasacion" AutoUpdateAfterCallBack="true" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            <anthem:Button PreCallBackFunction="this.disabled = true" PostCallBackFunction="this.disabled = false"
                                ...
                                OnMouseDown="javascript:MensajeConfirmacion('¿Seguro que desea Crear una Solicitud de Tasación para las Propiedades Seleccionadas?',this);" />
                        </div>
                    </div>
                </div>
            </div>
