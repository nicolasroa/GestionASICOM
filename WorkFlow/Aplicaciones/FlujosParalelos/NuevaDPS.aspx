<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="NuevaDPS.aspx.cs" Inherits="WorkFlow.Aplicaciones.FlujosParalelos.NuevaDPS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row spacenavmax">
        <div class="col-md-12">
            <h4>
                <span class="titulo">
                    <%--<img src="../../Img/icons/favicon_xsmall.png" />--%>Nueva DPS
                </span>
                <br>
            </h4>
            <%--<div style="width: 100%;">
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Buscar Solicitud para Iniciar Flujo de DPS
                    </h3>
                </div>
        ...
        <div class="col-md-5 small">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <anthem:GridView runat="server" ID="gvParticipantes" AutoGenerateColumns="false" Width="100%" CssClass="table table-condensed"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            <anthem:Button PreCallBackFunction="this.disabled = true" PostCallBackFunction="this.disabled = false"
                                EnabledDuringCallBack="False" ID="btnProcesarDPS" runat="server" CssClass="btn-sm btn-primary"
                                OnClick="BtnProcesarDPS_Click" Text="Procesar Inicio del Flujo" TextDuringCallBack="Procesando..."
