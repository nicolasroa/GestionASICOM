...
{
    public partial class NuevoEstudioTituloPiloto : System.Web.UI.Page
    {
        ...
        protected void ProcesarFlujo()
        {
            try
            {
                ...
                oSolicitud.Estado_Id = 8;//EETT Piloto en Curso
                ...
                {
                    IniciarFlujoEstudioTitulo(oSolicitud.Id, 2);//Se inicia Flujo de Tasación Piloto
                }
        ...
        private void IniciarFlujoEstudioTitulo(int Solicitud_Id, int TipoTasacion_Id)
        {
            try
            {
