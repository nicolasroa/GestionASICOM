<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="NuevoEstudioTituloPiloto.aspx.cs" Inherits="WorkFlow.Aplicaciones.FlujosParalelos.NuevoEstudioTituloPiloto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row spacenavmax">
        <div class="col-md-12">
            <h4>
                <span class="titulo">
                    <%--<img src="../../Img/icons/favicon_xsmall.png" />--%>Solicitud de EETT Piloto
                </span>
                <br>
            </h4>
           <%-- <div style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <anthem:Button PreCallBackFunction="this.disabled = true" PostCallBackFunction="this.disabled = false"
                ...
                OnMouseDown="javascript:MensajeConfirmacion('¿Seguro que desea Crear una Solicitud de EETT para el Proyecto Seleccionado?',this);" />
        </div>
    </div>
