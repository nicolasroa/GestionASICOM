        ...
        private void SeleccionarSolicitud(int Solicitud_Id)
        {
            try
            {
                ...
                if (NegSolicitudes.objSolicitudInfo != null)
                {
                    ...
                    NegBandejaEntrada.oBandejaEntrada.IndModificaDatosCredito = true;
                    NegBandejaEntrada.oBandejaEntrada.IndModificaDatosParticipantes = true;
                    NegBandejaEntrada.oBandejaEntrada.IndModificaDatosPropiedades = true;
                    NegBandejaEntrada.oBandejaEntrada.IndModificaDatosSeguros = true;
                    NegObservaciones.indModificaObservacion = true;
                    Controles.AbrirEvento("~/Aplicaciones/ActualizarSolicitud.aspx", "Actualizar Solicitud: " + NegSolicitudes.objSolicitudInfo.Id.ToString());
                }
            }
            catch (Exception Ex)
            {
