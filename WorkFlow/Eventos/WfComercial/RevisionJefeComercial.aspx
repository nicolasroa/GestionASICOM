<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="RevisionJefeComercial.aspx.cs" Inherits="WorkFlow.Eventos.RevisionJefeComercial" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Resolucion" data-toggle="tab" aria-expanded="true">Resolucion</a></li>
            </ul>
        </div>
