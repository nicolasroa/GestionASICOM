<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoDeRiesgo.aspx.cs" Inherits="WorkFlow.Eventos.ReparoDeRiesgo" %>
...
<%@ Register Src="~/DatosGenerales/DatosReparoRiesgo.ascx" TagPrefix="uc1" TagName="DatosReparoRiesgo" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
         ...
         <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Reparo" data-toggle="tab" aria-expanded="true">Reparo Riesgo</a></li>
            </ul>
        </div>
