<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoComercial.aspx.cs" Inherits="WorkFlow.Eventos.WfComercial.ReparoComercial" %>
    ...
    <div class="row navbar-fixed-top">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class=""><a href="#Resolucion" data-toggle="tab" aria-expanded="false">Resolución</a></li>
            </ul>
        </div>
