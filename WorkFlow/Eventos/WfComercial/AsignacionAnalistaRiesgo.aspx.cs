...
{
    public partial class AsignacionAnalistaRiesgo : System.Web.UI.Page
    {
        ...
        private void CargaComboAnalistaRiesgo()
        {
            try
            {
                ...
                {
                    Controles.CargarCombo<UsuarioInfo>(ref ddlAnalistaRiesgo, ObjetoResultado.Lista, "Rut", "Nombre", "-- Analista de Riesgo --", "-1");
                }
                else
                {
        ...
        private bool ValidarFormulario()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeAlerta("Debe Seleccionar un Analista de Riesgo");
                    return false;
                }
