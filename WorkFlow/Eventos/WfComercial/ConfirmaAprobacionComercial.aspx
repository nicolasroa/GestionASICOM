<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ConfirmaAprobacionComercial.aspx.cs" Inherits="WorkFlow.Eventos.ConfirmaAprobacionComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class=""><a href="#DocumentosOriginacionComercial" data-toggle="tab" aria-expanded="false">Originación Comercial</a></li>
    ...
    <div class="row spacenav">
        ...
        <div class="col-lg-12 text-right" >
            <anthem:Button ID="btnGeneraCertificadoAprobacion" runat="server" Text="Constancia de Aprobación" AutoUpdateAfterCallBack="True" CssClass="btn-sm btn-success" OnClick="btnGeneraCertificadoAprobacion_Click" EnableCallBack="False" />
             <anthem:Button ID="btnGenerarChecklistOriginacionComercial" runat="server" Text="Cheklist Originación Comercial" AutoUpdateAfterCallBack="True" CssClass="btn-sm btn-success" OnClick="btnGenerarChecklistOriginacionComercial_Click" EnableCallBack="False" />
    ...
    <div id="tabEvento" class="tab-content">
                                    ...
                                    <anthem:GridView runat="server" ID="gvSolicitudInversionistas" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Asignado" ItemStyle-HorizontalAlign="Center">
                                                <ControlStyle />
                                                <ItemTemplate>
                                                    <anthem:CheckBox ID="chkAsignado" AutoUpdateAfterCallBack="true" AutoCallBack="True" CssClass="form-control" runat="server" OnCheckedChanged="chkAsignado_CheckedChanged" />
                                            ...
                                            <asp:BoundField DataField="DescripcionEstado" HeaderText="Estado Avaluación" />
        ...
        <div class="tab-pane fade" id="DocumentosOriginacionComercial">
            <div class="row">
