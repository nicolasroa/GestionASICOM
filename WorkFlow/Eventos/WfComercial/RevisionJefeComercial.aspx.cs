...
{
    public partial class RevisionJefeComercial : System.Web.UI.Page
    {
        ...
        public bool ValidarSolicitud()
        {
            try
            {
                ...
                var RentaMaxima = NegConfiguracionGeneral.Obtener().MaximoDividendoRenta;
                if (DividendoRenta > RentaMaxima)
                {
                    Controles.MostrarMensajeAlerta("El % de Dividendo Renta no puede superar el " + string.Format("{0:P}", RentaMaxima.ToString().Replace(".", ",")));
                    return false;
                }
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al Validar la Solicitud");
                }
                return false;
            }
