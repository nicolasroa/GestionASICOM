...
{
    public partial class IngresoDeuda : System.Web.UI.Page
    {
        #region EVENTOS
        ...
        private void CargaClientes()
        {
            try
            {
                ...
                if (NegParticipante.lstParticipantes.Count != 0)
                {
                    ...
                    Controles.CargarGrid(ref EstadoSituacion.AgdvParticipante, NegParticipante.lstParticipantes, new string[] { "Id" });
                }
                else
                {
        ...
        private void GenerarReportePDF()
        {
            try
            {
                ...
                string urlDocumento = "~/Reportes/PDF/FichaEvaluacionFinanciamiento.aspx";
                string ContenidoHtml = "";
                string Archivo = "FichaEvalFin_Solicitud_" + NegSolicitudes.objSolicitudInfo.Id.ToString() + ".pdf";
                Pdf.NombreDocumentoPDF = Archivo;
                Pdf.ModuloDocumentoPDF = "Ficha Evaluación Financiamiento";
