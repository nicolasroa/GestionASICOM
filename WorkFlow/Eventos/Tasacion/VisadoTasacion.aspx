<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="VisadoTasacion.aspx.cs" Inherits="WorkFlow.Eventos.Tasacion.VisadoTasacion" %>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="DatosTasacion">
            <div class="row">
                <div class="col-md-12">
                    <div class='form-group'>
                        <label for="txtFechaAprobacionTasación">Fecha de Aprobación Tasación</label>
                        <anthem:TextBox ID="txtFechaAprobacionTasación" runat="server" onblur="esFechaValida(this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <anthem:TextBox ID="txtFechaRecepcionFinal" runat="server" Enabled="false" onblur="esFechaValida(this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                    <div class='form-group'>
                                        <label for="txtPermisoEdificacion">Permiso de Edificación</label>
                                        <anthem:TextBox ID="txtPermisoEdificacion" runat="server" Enabled="false" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class='form-group'>
                                        ...
                                        <anthem:TextBox ID="txtAñoConstruccion" runat="server" Enabled="false" onKeyPress="return SoloNumeros(event,this.value,0,this);" MaxLength="4" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                    <div class='form-group'>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <anthem:TextBox ID="txtMetrosConstruccion" runat="server" Enabled="false" onKeyPress="return SoloNumeros(event,this.value,4,this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                    <div class='form-group'>
                                        <label for="txtRolManzana">Rol - Manzana</label>
                                        <anthem:TextBox ID="txtRolManzana" runat="server" Enabled="false" onKeyPress="return SoloNumeros(event,this.value,0,this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                    <div class='form-group'>
                                        <label for="txtRolSitio">Rol - Sitio</label>
                                        <anthem:TextBox ID="txtRolSitio" runat="server" Enabled="false" onKeyPress="return SoloNumeros(event,this.value,0,this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row text-center">
                                <div class="col-md-12">
                                    <anthem:LinkButton ID="btnCancelarTasacion" class="btn btn-warning" runat="server" OnClick="btnCancelarTasacion_Click"><span class="glyphicon glyphicon-trash"></span>Limpiar</anthem:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
