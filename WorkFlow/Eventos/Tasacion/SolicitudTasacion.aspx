<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="SolicitudTasacion.aspx.cs" Inherits="WorkFlow.Eventos.Tasacion.SolicitudTasacion" %>
                                ...
                                <div class="col-md-12">
                                    <anthem:GridView runat="server" ID="gvPropiedadesTasacion" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FechaSolicitudTasacion" HeaderText="Fecha de Solicitud" NullDisplayText="Pendiente" DataFormatString="{0:d}" />
