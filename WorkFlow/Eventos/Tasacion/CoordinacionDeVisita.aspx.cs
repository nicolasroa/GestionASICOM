...
{
    public partial class CoordinacionDeVisita : System.Web.UI.Page
    {
        ...
        private bool ValidarPropiedades()
        {
            try
            {
                ...
                if (NegPropiedades.lstPropiedadesTasaciones.Count(t => t.FechaCoordinacionTasacion == null && t.IndPropiedadPrincipal == true) != 0)
                {
                    Controles.MostrarMensajeAlerta("Debe Completar los Datos de la Visita a Tasación de todas las Propiedades");
                    return false;
                }
        ...
        private void CargarInfoTasacion(TasacionInfo oTasacion)
        {
            try
            {
                if (oTasacion != null)
                {
                    ...
                    txtFechaCoordinacionTasacion.Text = oTasacion.FechaCoordinacionTasacion == null ? "" : oTasacion.FechaCoordinacionTasacion.Value.ToShortDateString();
                    ddlHoraVisitaTasacion.SelectedValue = oTasacion.FechaCoordinacionTasacion == null ? "" : oTasacion.FechaCoordinacionTasacion.Value.ToShortTimeString();
                }
            }
            catch (Exception Ex)
            {
        ...
        private void GrabarInfoTasacion()
        {
            try
            {
                ...
                oTasacion.FechaCoordinacionTasacion = DateTime.Parse(txtFechaCoordinacionTasacion.Text + " " + ddlHoraVisitaTasacion.SelectedValue);
        ...
        private void LimpiarInfoTasacion()
        {
            ...
            txtFechaCoordinacionTasacion.Text = "";
            ddlHoraVisitaTasacion.ClearSelection();
        ...
        private bool ValidarInfoTasacion()
        {
            try
            {
                ...
                if (txtFechaCoordinacionTasacion.Text == "")
                {
                    Controles.MostrarMensajeAlerta("Debe Ingresar una Fecha de Visita de Tasación");
                    return false;
                }
                if (ddlHoraVisitaTasacion.SelectedValue == "")
                {
                    Controles.MostrarMensajeAlerta("Debe Ingresar una Hora de Visita de Tasación");
                    return false;
                }
