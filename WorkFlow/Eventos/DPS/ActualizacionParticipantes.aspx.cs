...
{
    public partial class ActualizacionParticipantes : System.Web.UI.Page
    {
        ...
        private bool ValidarParticipantes()
        {
            try
            {
                ...
                foreach (var participante in NegParticipante.lstParticipantes)
                {
                    ...
                    if (participante.PorcentajeDeuda > 0 && (participante.TipoParticipacion_Id == 1 || participante.TipoParticipacion_Id == 2)) //Validación Solo para el Deudor Principal y Codeudor
                    {
