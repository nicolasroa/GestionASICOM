<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ActualizacionParticipantes.aspx.cs" Inherits="WorkFlow.Eventos.DPS.ActualizacionParticipantes" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Participantes" data-toggle="tab" aria-expanded="true">Actualización de Participantes</a></li>
            </ul>
        </div>
