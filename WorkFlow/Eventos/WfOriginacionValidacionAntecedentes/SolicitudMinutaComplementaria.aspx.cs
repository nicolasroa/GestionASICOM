...
{
    public partial class SolicitudMinutaComplementaria : System.Web.UI.Page
    {
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "A"))//AVANZAR
                {
                    ...
                    if (DateTime.TryParse(txtFechaSolicitudMinutaComplementaria.Text, out Fecha))
                    {
                        NegSolicitudes.objSolicitudInfo.FechaSolicitudMinutaComplementaria = Fecha;
