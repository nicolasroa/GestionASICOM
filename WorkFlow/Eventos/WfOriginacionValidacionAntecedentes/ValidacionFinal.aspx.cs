...
{
    public partial class ValidacionFinal : System.Web.UI.Page
    {
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "A"))//AVANZAR
                {
                    ...
                    if (DateTime.TryParse(txtFechaValidacionFinal.Text, out Fecha))
                    {
                        NegSolicitudes.objSolicitudInfo.FechaValidacionFinal = Fecha;
