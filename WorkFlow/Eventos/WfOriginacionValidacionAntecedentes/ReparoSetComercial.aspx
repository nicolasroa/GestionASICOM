<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoSetComercial.aspx.cs" Inherits="WorkFlow.Eventos.WfOriginacionValidacionAntecedentes.ReparoSetComercial" %>
                        ...
                        <div class="panel-body">
                            <anthem:GridView runat="server" ID="gvDocumentosRequeridos" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DescripcionEstadoRevision" HeaderText="Estado" />
