<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ConfeccionMinutaComplementaria.aspx.cs" Inherits="WorkFlow.Eventos.WfOriginacionValidacionAntecedentes.ConfeccionMinutaComplementaria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script>
        ...
        function InicioEvento() {
            try {
                $("#<%= txtFechaConfeccionMinutaComplementaria.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    maxDate: 0,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#ConfeccionMinutaComplementaria" data-toggle="tab" aria-expanded="true">Confección de Minuta Complementaria</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="ConfeccionMinutaComplementaria">
            <div class="row">
                <div class="col-lg-4"></div>
                <div class="col-lg-4">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">Confección de Minuta Complemantaria</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <label for="txtFechaConfeccionMinutaComplementaria">Fecha de Confeccion</label>
                                    <anthem:TextBox ID="txtFechaConfeccionMinutaComplementaria" runat="server" onblur="esFechaValida(this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
