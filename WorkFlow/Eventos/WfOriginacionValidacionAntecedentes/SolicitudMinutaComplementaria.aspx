<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="SolicitudMinutaComplementaria.aspx.cs" Inherits="WorkFlow.Eventos.WfOriginacionValidacionAntecedentes.SolicitudMinutaComplementaria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        function InicioEvento() {
            try {
                $("#<%= txtFechaSolicitudMinutaComplementaria.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    maxDate: 0,
    ...
    <div class="row navbar-fixed-top">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#SolicitudMinutaComplementaria" data-toggle="tab" aria-expanded="true">Solicitud de Minuta Complementaria</a></li>
            </ul>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">Solicitud de Minuta Complemantaria</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <label for="txtFechaSolicitudMinutaComplementaria">Fecha de Solicitud</label>
                                    <anthem:TextBox ID="txtFechaSolicitudMinutaComplementaria" runat="server" onblur="esFechaValida(this);" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
