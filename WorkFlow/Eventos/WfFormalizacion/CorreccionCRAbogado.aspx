<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CorreccionCRAbogado.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.CorreccionCRAbogado" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Firma" data-toggle="tab" aria-expanded="true">Correccion Docuemnto</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Firma">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Corrección Carta de Resguardo</h3>
                </div>
                <div class='form-group'>
                    <br />
                </div>
                <div class="panel-body">
                    <div class='form-group'>
                        <anthem:GridView runat="server" ID="gvGarantias" AutoGenerateColumns="false" Width="100%"
                            PageSize="5" AllowSorting="True" AutoUpdateAfterCallBack="true" UpdateAfterCallBack="True" CssClass="table table-condensed">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Fecha Correccion CR" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                         <anthem:TextBox ID="txtFechaCorreccion" class="txtFechaPicker" runat="server" AutoUpdateAfterCallBack="true" onblur="esFechaValida(this);" Width="25%"></anthem:TextBox>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Guardar" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <anthem:ImageButton ID="btnGuardaFirma" runat="server" ImageUrl="~/Img/icons/Grabar.png"
                                            ToolTip="GUardar" TextDuringCallBack="Guardando Registro..." OnClick="btnGuardaFirma_Click" />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </asp:TemplateField>
                            </Columns>
