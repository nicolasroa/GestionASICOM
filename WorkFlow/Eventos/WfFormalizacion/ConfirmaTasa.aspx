<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ConfirmaTasa.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.ConfirmaTasa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#ConfirmaTasa" data-toggle="tab" aria-expanded="true">Confirmación</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="ConfirmaTasa">
         <div class="row">
                <div class="col-lg-12">
