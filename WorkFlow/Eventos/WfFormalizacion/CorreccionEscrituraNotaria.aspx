<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CorreccionEscrituraNotaria.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.CorreccionEscrituraNotaria" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
       <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Firma" data-toggle="tab" aria-expanded="true">Corrección Escritura Notaría</a></li>
            </ul>
        </div>
