<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="VerificarEscrituraCorregida.aspx.cs" Inherits="WorkFlow.Eventos.VerificarEscrituraCorregida" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Verificar" data-toggle="tab" aria-expanded="false">Verificar Escritura Corregida</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Verificar">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso de Fecha Verificación Escritura Corregida
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-3">
                            <label for="txtFecha" class="control-label">Fecha Verificación Corrección Escritura</label>
                        </div>
