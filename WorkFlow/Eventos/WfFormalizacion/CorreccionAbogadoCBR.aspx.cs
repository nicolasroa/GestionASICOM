...
{
    public partial class CorreccionAbogadoCBR : System.Web.UI.Page
    {
        ...
        public void CargaFormulario()
        {
            ...
            txtFecha.Text = NegConservador.ObjInfoDatosCBR.FechaCorreccionAbogadoCBR.ToString();
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegConservador.ObjInfoDatosCBR.FechaCorreccionAbogadoCBR = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Corrección Abogado CBR");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha Corrección Abogado CBR");
                    return false;
                }
                return true;
            }
