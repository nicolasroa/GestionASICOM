<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoVisacion.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.ReparoVisacion" %>
                                ...
                                <div class="col-lg-12">
                                    <anthem:GridView runat="server" ID="gvParticipantes" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FechaIngresoDPS" HeaderText="Fecha Ingreso DPS" DataFormatString="{0:d}" NullDisplayText="Pendiente" />
                                            <asp:BoundField DataField="FechaAprobacionDPS" HeaderText="Fecha Aprobación DPS" DataFormatString="{0:d}" NullDisplayText="Pendiente" />
