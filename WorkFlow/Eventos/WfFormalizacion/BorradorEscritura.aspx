<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="BorradorEscritura.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.BorradorEscritura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function InicioBorrador() {
            try {
                $("#<%= txtFechaBorrador.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    maxDate: 0,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Borrador" data-toggle="tab" aria-expanded="true">Borrador</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Borrador">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <anthem:TextBox ID="txtFechaBorrador" runat="server" class="form-control" onblur="esFechaValida(this);" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                </div>
