<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="RevisionInscripcion.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.RevisionInscripcion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Verificar" data-toggle="tab" aria-expanded="false">Revisión Inscripciones</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Verificar">
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos CBR
                                <anthem:Label ID="lblCBR" runat="server" AutoUpdateAfterCallBack="true"></anthem:Label>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class='form-group'>
                                        <label for="txtFechaIngresoCBR">Fecha Ingreso</label>
                                        <anthem:TextBox ID="txtFechaIngresoCBR" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class='form-group'>
                                        <label for="txtNroIngreso">Número de Ingreso</label>
                                        <anthem:TextBox ID="txtNroIngreso" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class='form-group'>
                                        <label for="txtFechaSalida">Fecha Salida</label>
                                        <anthem:TextBox ID="txtFechaSalida" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class='form-group'>
                                        <label for="txtFechaSalida">Fecha Revisión Inscripciones</label>
                                        <anthem:TextBox ID="txtFecha" runat="server" AutoUpdateAfterCallBack="True" CssClass="form-control" onblur="esFechaValida(this);"></anthem:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6 text-center">
                                    <anthem:LinkButton ID="AbtnGuardar" class="btn-sm btn-primary" runat="server" TextDuringCallBack="Procesando" EnabledDuringCallBack="false" OnClick="AbtnGuardar_Click"><span class="glyphicon glyphicon-floppy-save"></span> Grabar Datos</anthem:LinkButton>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos de las Inscripciones
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Dominio
                                            </h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class='form-group'>
                                                <label for="txtNroDominio">Número</label>
                                                <anthem:TextBox ID="txtNroDominio" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                            <div class='form-group'>
                                                <label for="txtFojasDominio">Fojas</label>
                                                <anthem:TextBox ID="txtFojasDominio" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Hipoteca
                                            </h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class='form-group'>
                                                <label for="txtNroHipoteca">Número</label>
                                                <anthem:TextBox ID="txtNroHipoteca" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                            <div class='form-group'>
                                                <label for="txtFojasHipoteca">Fojas</label>
                                                <anthem:TextBox ID="txtFojasHipoteca" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Prohibición
                                            </h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class='form-group'>
                                                <label for="txtNroProhibicion">Número</label>
                                                <anthem:TextBox ID="txtNroProhibicion" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                            <div class='form-group'>
                                                <label for="txtFojasProhibicion">Fojas</label>
                                                <anthem:TextBox ID="txtFojasProhibicion" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
