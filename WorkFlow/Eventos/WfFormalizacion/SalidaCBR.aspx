<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="SalidaCBR.aspx.cs" Inherits="WorkFlow.Eventos.SalidaCBR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function InicioDatepicker() {
            ...
            try {
                $("#<%= txtFechaSalidaCBR.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                ...
                $("#<%= txtFechaEnvioInforme.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    constrainInput: true, //La entrada debe cumplir con el formato
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Salida" data-toggle="tab" aria-expanded="true">Salida CBR</a></li>
            </ul>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos Salida CBR</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class='form-group'>
                                        <label for="txtFechaSalidaCBR">Fecha Salida CBR</label>
                                        <anthem:TextBox ID="txtFechaSalidaCBR" runat="server" AutoUpdateAfterCallBack="True" CssClass="form-control" onblur="esFechaValida(this);"></anthem:TextBox>
                                    </div>
                                    <div class='form-group'>
                                        <label for="txtFechaEnvioInforme">Fecha de Envío de Informe</label>
                                        <anthem:TextBox ID="txtFechaEnvioInforme" runat="server" AutoUpdateAfterCallBack="True" CssClass="form-control" onblur="esFechaValida(this);"></anthem:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Datos Incripción Dominio</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class='form-group'>
                                                        <label for="txtDominio">Número</label>
                                                        <anthem:TextBox ID="txtNumeroDominio" runat="server" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                                    </div>
                                                    <div class='form-group'>
                                                        <label for="txtFojasDominio">Fojas</label>
                                                        <anthem:TextBox ID="txtFojasDominio" runat="server" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Datos Incripción Prohibición</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class='form-group'>
                                                        <label for="txtNumeroProhibicion">Número</label>
                                                        <anthem:TextBox ID="txtNumeroProhibicion" runat="server" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                                    </div>
                                                    <div class='form-group'>
                                                        <label for="txtFojasProhibicion">Fojas</label>
                                                        <anthem:TextBox ID="txtFojasProhibicion" runat="server" class="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
