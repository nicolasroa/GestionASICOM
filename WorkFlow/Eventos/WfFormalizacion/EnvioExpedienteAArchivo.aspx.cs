...
{
    public partial class EnvioExpedienteAArchivo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaEnvioExpedienteArchivo == null ? "" : NegSolicitudes.objSolicitudInfo.FechaEnvioExpedienteArchivo.Value.ToShortDateString();
            }
        }
        ...
        public bool ValidaEvento()
        {
            try
            {
                ...
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaEnvioExpedienteArchivo != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Envío Expediente a Archivo.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaEnvioExpedienteArchivo = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Envío de Expediente a Archivo para el Evento");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar la fecha de Envío Expediente a Archivo.");
                    return false;
                }
                return true;
            }
