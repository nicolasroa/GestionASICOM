...
{
    public partial class InstruccionNotarial : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaInstruccionNotarial.ToString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaFechaInstruccionNotarial()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaFechaInstruccionNotarial()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaInstruccionNotarial != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha Instrucción NOtarial.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaInstruccionNotarial()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaInstruccionNotarial = DateTime.Parse(txtFecha.Text);
