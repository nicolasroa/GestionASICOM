<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CoordinacionFirmas.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.CoordinacionFirmas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function InicioCoordinacion() {
            try {
                $("#<%= txtFechaCoordinacionFirmas.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    maxDate: 0,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Coordinacion" data-toggle="tab" aria-expanded="true">Coordinación</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Coordinacion">
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos del Borrador 
                            </h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class='form-group'>
                                        ...
                                        <anthem:Label ID="lblAbogado" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:Label>
                                    </div>
                                    <div class='form-group'>
                                    ...
                                    <div class='form-group'>
                                        <label for="lblDireccionNotaria">Dirección Notaría</label>
                                        <anthem:Label ID="lblDireccionNotaria" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:Label>
                                    </div>
                                    <div class='form-group'>
                                        <label for="lblContactoNotaria">Contacto Notaría</label>
                                        <anthem:Label ID="lblContactoNotaria" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:Label>
                                    </div>
                                    <div class='form-group'>
                                        <label for="txtFechaCoordinacionFirmas">Fecha Coordinación de Firmas</label>
                                        <anthem:TextBox ID="txtFechaCoordinacionFirmas" runat="server" class="form-control" onblur="esFechaValida(this);" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <anthem:GridView runat="server" ID="gvParticipantes" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Mail" HeaderText="Correo Electronico" />
                                            <asp:BoundField DataField="TelefonoMovil" HeaderText="Teléfono Movil" />
                                            <asp:BoundField DataField="TelefonoFijo" HeaderText="Teléfono Fijo" />
                                        </Columns>
                                    </anthem:GridView>
                                </div>
                            </div>
