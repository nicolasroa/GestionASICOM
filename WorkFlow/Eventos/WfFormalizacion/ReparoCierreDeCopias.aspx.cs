...
{
    public partial class ReparoCierreDeCopias : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaReparoCierreDeCopias == null ? "" : NegSolicitudes.objSolicitudInfo.FechaReparoCierreDeCopias.Value.ToShortDateString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaReparoCierreDeCopias()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaReparoCierreDeCopias()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaReparoCierreDeCopias != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Reparo Cierre de Copias.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaReparoCierreDeCopias = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Reparo Cierre de Copias");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha Reparo Cierre de Copias");
                    return false;
                }
                return true;
            }
