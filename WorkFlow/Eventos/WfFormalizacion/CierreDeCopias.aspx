<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CierreDeCopias.aspx.cs" Inherits="WorkFlow.Eventos.CierreDeCopias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Correccion" data-toggle="tab" aria-expanded="true">Cierre de Copias</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Correccion">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso de Fecha Cierre de Copias</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-2">
                            <label for="txtFecha" class="control-label">Fecha Cierre de Copias</label>
                        </div>
                        <div class="col-lg-2">
