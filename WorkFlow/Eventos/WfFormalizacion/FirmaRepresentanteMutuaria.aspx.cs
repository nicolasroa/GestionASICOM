...
{
    public partial class FirmaRepresentanteMutuaria : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                    ...
                    txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaFirmaRepresentanteMutuaria == null ? "" : NegSolicitudes.objSolicitudInfo.FechaFirmaRepresentanteMutuaria.Value.ToShortDateString();
            }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaFechaFirmaRepresentanteMutuaria()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaFechaFirmaRepresentanteMutuaria()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();

                    oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaFirmaRepresentanteMutuaria != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Firma de Representante Mutuaria.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaRepresentanteMutuaria()
        {
            try
            {
                ...
                //Asignacion de Variables
                    ...
                    NegSolicitudes.objSolicitudInfo.FechaFirmaRepresentanteMutuaria = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Firma Representante Mutuaria");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha Firma Representante Mutuaria");
                    return false;
                }
                return true;
            }
        ...
        protected void AbtnGuarda_Click(object sender, EventArgs e)
        {
            if (ValidaInfo())
            {
                GrabaFechaFirmaRepresentanteMutuaria();
            }
            else
            {
