<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="IngresoACBR.aspx.cs" Inherits="WorkFlow.Eventos.IngresoACBR" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Ingreso" data-toggle="tab" aria-expanded="true">Ingreso a CBR</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Ingreso">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso A CBR</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <label for="txtNroIngreso" class="control-label">N° de Carátula</label>
                        </div>
                        <div class="col-lg-2">
                            <anthem:TextBox ID="txtNroIngreso" runat="server" CssClass="form-control" AutoUpdateAfterCallBack="True"></anthem:TextBox>
                        </div>
                        <div class="col-lg-2">
                            <label for="txtFecha" class="control-label">Fecha Ingreso A CBR</label>
                        </div>
                        <div class="col-lg-2">
