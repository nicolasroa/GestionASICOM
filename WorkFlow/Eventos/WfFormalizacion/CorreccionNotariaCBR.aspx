<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CorreccionNotariaCBR.aspx.cs" Inherits="WorkFlow.Eventos.CorreccionNotariaCBR" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Correccion" data-toggle="tab" aria-expanded="true">Correccion Notaria CBR</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Correccion">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso de Fecha Corrección Notaría CBR</h3>
                </div>
                <div class='form-group'>
                    <br />
                </div>
                <div class='form-group'>
                    <label for="txtFecha" class="col-lg-6 control-label">Fecha Corrección Notaría CBR</label>
