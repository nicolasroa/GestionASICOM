<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="FirmaRepresentanteMutuaria.aspx.cs" Inherits="WorkFlow.Eventos.FirmaRepresentanteMutuaria" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Firma" data-toggle="tab" aria-expanded="false">Firma Representante Mutuaria</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Firma">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso de Fecha de Firma Representante Mutuaria</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-3">
                            <label for="txtFecha" class="control-label">Fecha Firma Representante Mutuaria</label>
                        </div>
                        <div class="col-lg-2">
                            <anthem:TextBox ID="txtFecha" runat="server" CssClass="form-control" AutoUpdateAfterCallBack="True" onblur="esFechaValida(this);"></anthem:TextBox>
                        </div>
                    </div>
                    <div class='form-group'>
                        <br />
                    ...
                    <div class="col-md-12 text-center">
                        <anthem:Button ID="AbtnGuarda" runat="server" Text="Guardar" AutoUpdateAfterCallBack="true" CssClass="btn-sm btn-success" TextDuringCallBack="Guardando..." OnClick="AbtnGuarda_Click" />
