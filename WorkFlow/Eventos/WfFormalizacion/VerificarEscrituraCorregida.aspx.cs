...
{
    public partial class VerificarEscrituraCorregida : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaVerificarEscrituraCorregida == null ? "" : NegSolicitudes.objSolicitudInfo.FechaVerificarEscrituraCorregida.Value.ToShortDateString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "A"))//AVANZAR
                {
                    ...
                    if (!ValidaFechaVerificarEscrituraCorregida()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //aqui va las validaciones
        ...
        public bool ValidaFechaVerificarEscrituraCorregida()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaVerificarEscrituraCorregida != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Verificación de Escritura Corregida.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaVerificarEscrituraCorregida = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Verificación Escritura Corregida para el Evento");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar la fecha de Verificación de Escritura Corregida.");
                    return false;
                }
                return true;
            }
