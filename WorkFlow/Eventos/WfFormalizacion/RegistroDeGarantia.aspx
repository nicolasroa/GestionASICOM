<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="RegistroDeGarantia.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.RegistroDeGarantia" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Verificar" data-toggle="tab" aria-expanded="false">Registro Garantía</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Verificar">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso Fecha de Registro de Garantía
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-2">
                            <label for="txtFecha" class="control-label">Fecha Registro de Garantía</label>
                        </div>
