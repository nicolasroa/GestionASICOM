...
{
    public partial class CorreccionEscrituraNotaria : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaCorreccionEscrituraNotaria == null ? "" : NegSolicitudes.objSolicitudInfo.FechaCorreccionEscrituraNotaria.Value.ToShortDateString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaFechaFirmaCorreccionEscrituraNotaria()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaFechaFirmaCorreccionEscrituraNotaria()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaCorreccionEscrituraNotaria != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Corrección de Escritura en Notaría.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaCorreccionEscritura()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaCorreccionEscrituraNotaria = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Correccion Escritura en Notaría para el Evento");
                }
            }
        }
        ...
        protected void AbtnGuardar_Click(object sender, EventArgs e)
        {
            if (ValidaInfo())
            {
                GrabaFechaFirmaCorreccionEscritura();
            }
            else
            {
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha de Corrección de Escritura en Notaría");
                    return false;
                }
                return true;
            }
