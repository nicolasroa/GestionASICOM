<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ConfeccionEscritura.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.ConfeccionEscritura" %>
...
<%@ Register Src="~/DatosGenerales/DatosFlujoSolicitud.ascx" TagPrefix="uc1" TagName="DatosFlujoSolicitud" %>
    ...
    <script>
        function InicioBorrador() {
            try {
                $("#<%= txtFechaConfeccionEscritura.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    maxDate: 0,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Escritura" data-toggle="tab" aria-expanded="true">Escritura</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Escritura">
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos de la Escritura 
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    ...
                                    <div class='form-group'>
                                        <anthem:Label ID="lblFechaBorrador" for="txtFechaBorrador" AutoUpdateAfterCallBack="true" class="labelForm" Text="Fecha de Término Borrador" runat="server"></anthem:Label>
                                        <anthem:TextBox ID="txtFechaBorrador" runat="server" class="form-control" onblur="esFechaValida(this);" AutoUpdateAfterCallBack="True" Enabled ="false"></anthem:TextBox>
                                    </div>
                                     <div class='form-group'>
                                        <anthem:Label ID="lblFechaConfeccionEscritura" for="txtFechaConfeccionEscritura" AutoUpdateAfterCallBack="true" class="labelForm" Text="Fecha de Término Escritura" runat="server"></anthem:Label>
                                        <anthem:TextBox ID="txtFechaConfeccionEscritura" runat="server" class="form-control" onblur="esFechaValida(this);" AutoUpdateAfterCallBack="True" ></anthem:TextBox>
                                    </div>
                                </div>
                                  <div class="col-lg-4 text-center">
                                      </div>
