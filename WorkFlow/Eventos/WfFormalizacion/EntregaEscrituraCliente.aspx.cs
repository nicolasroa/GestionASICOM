...
{
    public partial class EntregaEscrituraCliente : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaEntregaEscrituraCliente == null ? "" : NegSolicitudes.objSolicitudInfo.FechaEntregaEscrituraCliente.Value.ToShortDateString();
            }
        }
        ...
        public bool ValidaEvento()
        {
            try
            {
                ...
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaEntregaEscrituraCliente != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Entrega de Escritura Cliente.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaEntregaEscrituraCliente = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Entrega Escritura Cliente para el Evento");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar la fecha de Entrega Escritura Cliente.");
                    return false;
                }
                return true;
            }
