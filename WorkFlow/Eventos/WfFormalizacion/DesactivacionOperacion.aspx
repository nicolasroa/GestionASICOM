<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="DesactivacionOperacion.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.DesactivacionOperacion" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Desactivacion" data-toggle="tab" aria-expanded="true">Desactivación</a></li>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class='form-group'>
                                        <label for="txtDestinado">Fecha de Desactivación</label>
                                        <anthem:TextBox ID="txtFechaDesActivacion" runat="server" class="form-control" AutoUpdateAfterCallBack="True" Enabled="false"></anthem:TextBox>
                                    </div>
                                </div>
