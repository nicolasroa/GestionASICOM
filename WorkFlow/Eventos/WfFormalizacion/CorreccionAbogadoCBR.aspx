<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="CorreccionAbogadoCBR.aspx.cs" Inherits="WorkFlow.Eventos.CorreccionAbogadoCBR" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Correccion" data-toggle="tab" aria-expanded="true">Corrección Abogado CBR</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade active in" id="Correccion">
            ...
            <div class="panel panel-primary">
                ...
                <div class='form-group'>
                    <label for="txtFecha" class="col-lg-6 control-label">Fecha Corrección Abogado CBR</label>
