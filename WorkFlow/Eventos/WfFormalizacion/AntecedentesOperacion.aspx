<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="AntecedentesOperacion.aspx.cs" Inherits="WorkFlow.Eventos.WfFormalizacion.AntecedentesOperacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function DesplegarDatosTasacion(Visible) {
            if (Visible === "1") {
                $('#DatosTasacion').show(500);
            } else {
                $('#DatosTasacion').hide(500);
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class=""><a href="#Flujos" data-toggle="tab" aria-expanded="false">Tasación/Estudio de Título</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade" id="Flujos">
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">Flujo de Tasación</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <anthem:RadioButtonList ID="rblIndFlujoTasacion" runat="server" AutoCallBack="true" OnSelectedIndexChanged="rblIndFlujoTasacion_SelectedIndexChanged">
                                        <Items>
                                            <asp:ListItem Value="0">Aplica Tasación Piloto</asp:ListItem>
                                            <asp:ListItem Value="1">Aplica Flujo de Tasación</asp:ListItem>
                                        </Items>
                                    </anthem:RadioButtonList>
                                </div>
                            </div>
                            <div id="DatosTasacion">
                                <div class="row">
                                    <div class="col-md-12">
                                        <anthem:GridView runat="server" ID="gvPropiedadesTasacion" AutoGenerateColumns="false" Width="100%"
                                            PageSize="10" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="gvPropiedadesTasacion_PageIndexChanging"
                ...
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">Flujo de Estudio de Título</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <anthem:RadioButtonList ID="rblIndFlujoEstudioTitulo" runat="server" AutoCallBack="true" OnSelectedIndexChanged="rblIndFlujoEstudioTitulo_SelectedIndexChanged">
                                        <Items>
                                            <asp:ListItem Value="0">Aplica EETT Piloto</asp:ListItem>
                                            <asp:ListItem Value="1">Aplica Flujo de EETT</asp:ListItem>
                                        </Items>
                                    </anthem:RadioButtonList>
                                </div>
                            </div>
                            <div id="DatosEstudioTitulo">
                                <div class="row">
                                    <div class="col-md-12">
                                        <anthem:GridView runat="server" ID="gvPropiedadesEETT" AutoGenerateColumns="false" Width="100%"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="DescripcionTipoInmueble" HeaderText="Tipo" />
                                                <asp:BoundField DataField="DireccionCompleta" HeaderText="Dirección" />
                                                <asp:BoundField DataField="NombreInstitucionAlzamientoHipoteca" HeaderText="Carta de Resguardo" NullDisplayText="No Aplica" />
                                                <asp:TemplateField HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                        ...
                                        <div class="panel panel-success">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class='form-group'>
                                                            <label for="ddlInstitucionAlzamientoHipoteca">Institución Alzamiento Hipoteca</label>
                                                            <anthem:DropDownList ID="ddlInstitucionAlzamientoHIpoteca" class="form-control" AutoUpdateAfterCallBack="true" runat="server"></anthem:DropDownList>
                                                        </div>
                                                ...
                                                <div class="row text-center">
                                                    <div class="col-md-12">
                                                        <anthem:LinkButton ID="btnGrabarEstudioTitulo" class="btn-sm btn-primary" runat="server" OnClick="btnGrabarEstudioTitulo_Click"><span class="glyphicon glyphicon-floppy-save"></span> Grabar EETT Piloto</anthem:LinkButton>

                                                        <anthem:LinkButton ID="btnCancelarEstudioTitulo" class="btn-sm btn-warning" runat="server" OnClick="btnCancelarEstudioTitulo_Click"><span class="glyphicon glyphicon-trash"></span> Cancelar Ingreso</anthem:LinkButton>
                                                    </div>
