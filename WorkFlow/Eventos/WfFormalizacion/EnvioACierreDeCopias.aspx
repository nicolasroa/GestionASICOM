<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="EnvioACierreDeCopias.aspx.cs" Inherits="WorkFlow.Eventos.EnvioACierreDeCopias" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Envio" data-toggle="tab" aria-expanded="true">Envio a Cierre de Copias</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Envio">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingreso de Fecha Envío a Cierre de Copias</h3>
                </div>
                <div class="panel-body">
                    <div class="row">

                        <div class="col-lg-3">
                            <label for="txtFecha" class="control-label">Fecha Envio a Cierre de Copias</label>
                        </div>
                        <div class="col-lg-2">
