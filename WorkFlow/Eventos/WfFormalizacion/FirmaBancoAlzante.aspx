<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="FirmaBancoAlzante.aspx.cs" Inherits="WorkFlow.Eventos.FirmaBancoAlzante" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Firma" data-toggle="tab" aria-expanded="true">Firma Banco Alzante</a></li>
            </ul>
        </div>
        ...
        <div class="tab-pane fade active in" id="Firma">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Firma Banco Alzante de Carta de Resguardo</h3>
                </div>
                    ...
                    <div class='form-group'>
                        <anthem:GridView runat="server" ID="gvGarantias" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Fecha Firma" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                         <anthem:TextBox ID="atxtFecha" class="txtFechaPicker center" runat="server" AutoUpdateAfterCallBack="true" onblur="esFechaValida(this);"></anthem:TextBox>
                                    </ItemTemplate>
