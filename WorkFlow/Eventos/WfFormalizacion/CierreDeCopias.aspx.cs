...
{
    public partial class CierreDeCopias : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaCierreDeCopias == null ? "" : NegSolicitudes.objSolicitudInfo.FechaCierreDeCopias.Value.ToShortDateString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaFechaCierreDeCopias()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaFechaCierreDeCopias()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaCierreDeCopias != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Cierre de Copias.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaCierreDeCopias()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaCierreDeCopias = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Cierre de Copias");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha Cierre de Copias");
                    return false;
                }
                return true;
            }
