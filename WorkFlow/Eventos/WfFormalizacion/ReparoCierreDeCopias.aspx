<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoCierreDeCopias.aspx.cs" Inherits="WorkFlow.DatosGenerales.ReparoCierreDeCopias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <script type="text/javascript">
    ...
    </script>       <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#Reparo" data-toggle="tab" aria-expanded="true">Reparo Cierre de Copias</a></li>
            </ul>
        </div>
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        Ingreso de Fecha Reparo Cierre de Copias</h3>
                </div>
             <div class='form-group'>
                    <br />
                </div>
                <div class='form-group'>
                    <label for="txtFecha" class="col-lg-6 control-label">Fecha Reparo Cierre de Copias</label>
                    <anthem:TextBox ID="txtFecha" runat="server" class="txtFechaPicker" AutoUpdateAfterCallBack="True"  onblur="esFechaValida(this);" ></anthem:TextBox>
                </div>
                <div class='form-group'>
                    <br />
                </div>
            ...
            <div class="col-md-12 text-center">
                <anthem:Button ID="AbtnGuardar" runat="server" Text="Guardar" AutoUpdateAfterCallBack="true" CssClass="btn-sm btn-success" OnClick="AbtnGuardar_Click" TextDuringCallBack="Guardando..." />
            ...
            <uc1:DatosObservaciones runat="server" ID="DatosObservaciones1" />
