...
{
    public partial class CorreccionNotariaCBR : System.Web.UI.Page
    {
        ...
        public void CargaFormulario()
        {
            ...
            txtFecha.Text = NegConservador.ObjInfoDatosCBR.FechaCorreccionNotariaCBR.ToString();
        }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegConservador.ObjInfoDatosCBR.FechaCorreccionNotariaCBR = DateTime.Parse(txtFecha.Text);
                oResultado = oNegocio.GuardarDatosCBR(oResultado.Lista[0]);
                if (oResultado.ResultadoGeneral)
                {
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Corrección Notaría CBR");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha Corrección Notaría CBR");
                    return false;
                }
                return true;
            }
