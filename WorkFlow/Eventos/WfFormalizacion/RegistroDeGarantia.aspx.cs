...
{
    public partial class RegistroDeGarantia : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaRegistroGarantia == null ? "" : NegSolicitudes.objSolicitudInfo.FechaRegistroGarantia.Value.ToShortDateString();
            }
        }
        ...
        public bool ValidaEvento()
        {
            try
            {
                ...
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaRegistroGarantia != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Registro de Garantía.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaRegistroGarantia = DateTime.Parse(txtFecha.Text);
