...
{
    public partial class EnvioACierreDeCopias : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaEnvioACierreDeCopias == null ? "" : NegSolicitudes.objSolicitudInfo.FechaEnvioACierreDeCopias.Value.ToShortDateString();
            }
        }
        ...
        public void ProcesarEvento()
        {
            try
            {
                ...
                {
                    //validacion
                    if (!ValidaEnvioACierreDeCopias()) return;
                }
                else if (oAccion.Sentido_Id == NegTablas.IdentificadorMaestro("SENTIDOS_WF", "F"))//FINALIZAR
                {
                    //validacion
        ...
        public bool ValidaEnvioACierreDeCopias()
        {
            try
            {
                SolicitudInfo oInfo = new SolicitudInfo();
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaEnvioACierreDeCopias != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha Envío a Cierre de Copias.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaEnvioACierreDeCopias = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Envío a Cierre de Copias");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar Fecha  Envío a Cierre de Copias");
                    return false;
                }
                return true;
            }
