...
{
    public partial class RevisionInscripcion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargarAcciones();
                txtFecha.Text = NegSolicitudes.objSolicitudInfo.FechaRevisionInscripcion == null ? "" : NegSolicitudes.objSolicitudInfo.FechaRevisionInscripcion.Value.ToShortDateString();
                BuscaDatosCBR();
            }
        }
        ...
        public bool ValidaEvento()
        {
            try
            {
                ...
                oInfo = NegSolicitudes.lstSolicitudInfo.FirstOrDefault(a => a.Id.Equals(NegBandejaEntrada.oBandejaEntrada.Solicitud_Id) && a.FechaRevisionInscripcion != null);
                if (oInfo == null)
                {
                    Controles.MostrarMensajeError("Debe ingresar fecha de Revisión Inscripción.");
                    return false;
                }
                return true;
            }
        ...
        public void GrabaFechaFirmaEnvio()
        {
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaRevisionInscripcion = DateTime.Parse(txtFecha.Text);
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError("Error al guardar Fecha Revisión Inscripción para el Evento");
                }
            }
        }
        ...
        public bool ValidaInfo()
        {
            try
            {
                ...
                {
                    Controles.MostrarMensajeInfo("Debe Ingresar la fecha de Revisión Inscripción.");
                    return false;
                }
                return true;
            }
        ...
        public void BuscaDatosCBR()
        {
            try
            {
                ...
                {
                    txtNroDominio.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().NroDominio.ToString();
                    txtNroHipoteca.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().NroHipoteca.ToString();
                    txtNroProhibicion.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().NroProhibicion.ToString();
                    txtFojasDominio.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().FojasDominio.ToString();
                    txtFojasHipoteca.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().FojasHipoteca.ToString();
                    txtFojasProhibicion.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().FojasProhibicion.ToString();
                    lblCBR.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().Conservador;
                    txtFechaIngresoCBR.Text = string.Format("{0:d}", NegConservador.ObjLstDatosCBR.FirstOrDefault().FechaIngresoCBR);
                    txtFechaSalida.Text = string.Format("{0:d}", NegConservador.ObjLstDatosCBR.FirstOrDefault().FechaSalidaCBR);
                    txtNroIngreso.Text = NegConservador.ObjLstDatosCBR.FirstOrDefault().NroIngresoCBR.ToString();
