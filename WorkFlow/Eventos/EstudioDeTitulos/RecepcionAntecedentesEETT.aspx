<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="RecepcionAntecedentesEETT.aspx.cs" Inherits="WorkFlow.Eventos.RecepcionAntecedentesEETT" %>
    ...
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                ...
                <li class="active"><a href="#EstudioTitulo" data-toggle="tab" aria-expanded="true">Recepción de EETT</a></li>
            </ul>
        </div>
