<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="RecepcionAntecedentesEETTPiloto.aspx.cs" Inherits="WorkFlow.Eventos.RecepcionAntecedentesEETTPiloto" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <anthem:DropDownList ID="ddlAbogado" runat="server" Enabled="true" class="form-control" AutoUpdateAfterCallBack="True"></anthem:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class='form-group'>
