...
{
    public partial class TerminoEETT : System.Web.UI.Page
    {
        ...
        private bool ActualizaSolicitud()
        {
            try
            {
                ...
                foreach (var tasacion in NegPropiedades.lstPropiedadesEETT)
                {
                    tasacion.EstadoEstudioTitulo_Id = (int)NegTablas.IdentificadorMaestro("ESTADOS_FLUJOS_PARALELOS", "T");// Terminada
                ...
                oTasacion.Solicitud_Id = NegPropiedades.lstPropiedadesEETT.FirstOrDefault().SolicitudEstudioTitulo_Id;
                ...
                {
                    tasacionInfo.EstadoEstudioTitulo_Id = (int)NegTablas.IdentificadorMaestro("ESTADOS_FLUJOS_PARALELOS", "T");// Terminada
