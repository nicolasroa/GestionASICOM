<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Eventos.Master" AutoEventWireup="true" CodeBehind="ReparoEETT.aspx.cs" Inherits="WorkFlow.Eventos.ReparoEETT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row navbar-fixed-top" style="background-color: #ffffff">
       ...
       <div class="col-lg-8 col-md-8 col-sm-12">
            ...
            <ul class="nav small nav-tabs">
                <li class="active"><a href="#Resumen" data-toggle="tab" aria-expanded="true">Resumen/Observaciones</a></li>
                ...
                <li class=""><a href="#EstudioTitulo" data-toggle="tab" aria-expanded="false">Solicitud de EETT</a></li>
            </ul>
        </div>
    ...
    <div id="tabEvento" class="tab-content">
        ...
        <div class="tab-pane fade" id="EstudioTitulo">
            <div class="row">
                <div class="col-md-12">
