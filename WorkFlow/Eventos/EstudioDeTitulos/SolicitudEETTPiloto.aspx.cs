...
{
    public partial class SolicitudEETTPiloto : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DatosDocumentosEstudioTitulo.PermitirActualizacionDocumentos(true);
        ...
        private bool ActualizaSolicitud()
        {
            ...
            try
            {
                ...
                NegSolicitudes.objSolicitudInfo.FechaSolicitudEstudioTitulo = DateTime.Parse(txtFechaSolicitudTasacion.Text);
