    ...
    public partial class Sucursales : System.Web.UI.Page
    {
        ...
        private void GuardarEntidad()
        {
            try
            {
                ...
                ObjetoResultado = oNegSucursal.Guardar(oEvento);
        ...
        private void CargarGrid()
        {
            try
            {
                ...
                var oEvento = new SucursalInfo();
                var NegSucursal = new NegSucursales();
                var ObjetoResultado = new Resultado<SucursalInfo>();
                ...
                ObjetoResultado = NegSucursal.Buscar(oEvento);
                if (ObjetoResultado.ResultadoGeneral)
                {
                    Controles.CargarGrid<SucursalInfo>(ref gvBusqueda, ObjetoResultado.Lista, new string[] { Constantes.StringId });
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError(ArchivoRecursos.ObtenerValorNodo(Constantes.MensajesUsuario.ErrorCargarGrid.ToString()) + " Sucursal");
                }
            }
        }
        private void ObtenerDatos(int Id)
        {
            try
            {
                ...
                oEvento.Id = Id;
                ObjetoResultado = oNegSucursal.Buscar(oEvento);
                ...
                if (ObjetoResultado.ResultadoGeneral == true)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Controles.MostrarMensajeError(ArchivoRecursos.ObtenerValorNodo(Constantes.MensajesUsuario.ErrorCargarEntidad.ToString()) + " Sucursal");
                        }
                    }
                }
            }
        ...
        private SucursalInfo DatosEntidad(SucursalInfo Entidad)
        {
            try
            {
                var ObjetoResultado = new Resultado<SucursalInfo>();
                ...
                ObjetoResultado = oNegSucursal.Buscar(Entidad);
        ...
        private void LlenarFormulario(SucursalInfo oEvento)
        {
            try
            {
                LimpiarFormulario();
            ...
            catch (Exception Ex)
            {
                ...
                {
                    Controles.MostrarMensajeError(ArchivoRecursos.ObtenerValorNodo(Constantes.MensajesUsuario.ErrorCargarFormulario.ToString()) + " Sucursal");
                }
            }
        }
