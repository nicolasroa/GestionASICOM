<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="TipoInmueble.aspx.cs" Inherits="WorkFlow.Mantenedores.TipoInmueble" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row spacenavmax">
        <div class="col-lg-12">
            <h4>
                <span class="titulo">
                    <%--<img src="../Img/icons/favicon_xsmall.png" />--%>Maestro de Tipos de Inmuebles
                </span>
                <br>
            </h4>
            <%--<div style="width: 100%;">
    ...
    <div id="accordion">
        ...
        <div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class='form-group'>
                        <label for="txtFormPorcSegIncendio" class="text-left">% Seguro Incendio</label>
                        <anthem:TextBox CssClass="form-control" AutoUpdateAfterCallBack="true" ID="txtFormPorcSegIncendio" onKeyPress="return SoloNumeros(event,this.value,0,this);" runat="server"></anthem:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class='form-group'>
                        <anthem:CheckBox ID="chkVisibleEnSimulador" AutoUpdateAfterCallBack="true" class="form-control" runat="server" Text="Visible en Simulador" />
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class='form-group'>
                        <anthem:CheckBox ID="chkIndEstudioTitulo" AutoUpdateAfterCallBack="true" class="form-control" runat="server" Text="Genera Estudio de Títulos" />
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class='form-group'>
                        
                        <anthem:CheckBox ID="chkIndTasacion" AutoUpdateAfterCallBack="true" class="form-control" runat="server" Text="Genera Tasación" />
                    </div>
                </div>
            </div>
            <div class="row">
