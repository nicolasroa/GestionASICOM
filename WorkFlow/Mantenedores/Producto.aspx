<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="Producto.aspx.cs" Inherits="WorkFlow.Mantenedores.Producto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row spacenavmax">
        <div class="col-md-12">
            <h4>
                <span class="titulo">
                    <%--<img src="../Img/icons/favicon_xsmall.png" />--%>Maestro de Producto
                </span>
                <br>
            </h4>
            <%--<div style="width: 100%;">
    ...
    <div id="accordion">
            ...
            <div class="row">
                 <div class="col-md-4">
                    <div class='form-group'>
                        <label for="ddlTipoFinanciamiento" class="text-left">Tipo Financiamiento</label>
                        <anthem:DropDownList ID="ddlTipoFinanciamiento" runat="server" CssClass="form-control" AutoUpdateAfterCallBack="true" AutoCallBack="True"></anthem:DropDownList>
                    </div>
                </div>
        ...
        <div>
            <div class="row">
               ...
               <div class="col-md-4">
                    <div class='form-group'>
                        <label for="ddlFormTipoFinanciamiento" class="text-left">Tipo Financiamiento</label>
                        <anthem:DropDownList ID="ddlFormTipoFinanciamiento" runat="server" CssClass="form-control" AutoUpdateAfterCallBack="true" AutoCallBack="True"></anthem:DropDownList>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class='form-group'>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                    <div class='form-group'>
                       <anthem:CheckBox ID="chIndMesesGracia" AutoUpdateAfterCallBack="true"   runat="server" Text="  Indicador Meses de Gracia" OnCheckedChanged="chIndMesesGracia_CheckedChanged" AutoCallBack="True" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class='form-group'>
                        <label for="txtFormMesesGracia" class="text-left">Meses</label>
                        <anthem:TextBox CssClass="form-control" ID="txtFormMesesGracia"  onKeyPress="return SoloNumeros(event,this.value,0,this);" runat="server" TabIndex="7"
                            AutoUpdateAfterCallBack="true"></anthem:TextBox>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class='form-group'>
                       <anthem:CheckBox ID="chkIndDoblePlazo" AutoUpdateAfterCallBack="true"   runat="server" Text="  Doble Plazo" />
                    </div>
                </div>
            </div>
